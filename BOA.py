...
from PyQt5.QtCore import (QCoreApplication, QMetaObject, QObject, QPoint,QRect, QSize, QUrl, Qt, QPropertyAnimation, QThread, pyqtSignal, pyqtSlot,QTimer)
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    ## PAGES
        ...
        self.ui.recognition_page.clicked.connect(lambda: self.ui.label_7.setText("recognition"))
        self.ui.open_cam.clicked.connect(self.open_camera2)
        ...
        self.ui.registration_page.clicked.connect(lambda: self.ui.label_7.setText("registration"))
        self.ui.pushButton_3.clicked.connect(self.open_camera)
        ...
        # PAGE 3
        self.ui.attendance_page.clicked.connect(lambda: self.ui.pages.setCurrentWidget(self.ui.page_4))
        self.ui.attendance_page.clicked.connect(lambda: self.ui.label_7.setText("info"))
        ###########################################################################################################################################
    ...
    def update_frame2(self):
        ...
        if ret ==True:
            ...
            self.ui.label_13.setAlignment(QtCore.Qt.AlignHCenter | QtCore.Qt.AlignVCenter)
    ...
    def take_attendance_image(self):
        ...
        while True:
            ...
            if M['m00'] != 1:
                    ...
                    mask = cv2.cvtColor(mask, cv2.COLOR_BGR2GRAY)
                    x,y,w,h = cv2.boundingRect(mask)
                    results = ROI[y:y+h,x:x+w]
                    mask = mask[y:y+h,x:x+w]
                    results[mask==0] = (0,0,0) 

                    imagenames=path+"/"+str(img_id)+".jpg"
                    cv2.imwrite(imagenames,results)
...
class SplashScreen(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # Change loading text
        QtCore.QTimer.singleShot(500, lambda: self.ui.label_loading.setText("LOADING DATA"))
        QtCore.QTimer.singleShot(1000, lambda: self.ui.label_loading.setText("LOADING ICON"))
        QtCore.QTimer.singleShot(1500, lambda: self.ui.label_loading.setText("LOADING TRAIN"))
        QtCore.QTimer.singleShot(2000, lambda: self.ui.label_loading.setText("LOADING TEST"))
